...
#         print("\n--- Comparison Summary ---")
#         print(f"Total files in A           : {len(files_in_a)}")
#         print(f"Total files in B           : {len(files_in_b)}")
#         print(f"Matched file paths         : {len(matched_paths)}")
#         print(f"  └── Identical content    : {len(identical_files)}")
#         print(f"  └── Different content    : {len(different_files)}")
#         print(f"Missing in B (A-only)      : {len(missing_in_b)}")
#         print(f"Extra in B (Not in A)      : {len(extra_in_b)}")
